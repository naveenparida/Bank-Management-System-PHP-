...
<h1 class="alert alert-primary rounded-0">Welcome to <?php echo bankname; ?></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 1000px">
...
</div><div class="p-3 mb-2 bg-light text-dark text-center text-primary font-weight-bold">Made by Naveen Parida<br>For The Spark Foundation(TSF) </p>
</div>
