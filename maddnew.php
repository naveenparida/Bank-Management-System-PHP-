 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item ">
        <a class="nav-link " href="mindex.php">User Accounts <span class="sr-only">(current)</span></a>
      </li>
...
{
  if (!$con->query("insert into useraccounts (name,accountNo,accountType,city,address,email,password,balance,number,branch) values ('$_POST[name]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[number]','$_POST[branch]')")) {
